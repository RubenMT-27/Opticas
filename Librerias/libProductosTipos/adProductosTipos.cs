// Clase en C Sharp creada automaticamente by ..:: ANCE A.C.  ::.. .Clase creada el: 15/03/2023 12:00:00 a. m. Version 3.3.2
using System;
...
namespace AnceSystem.libProductosTipos
{

   public class adProductosTipos : entProductosTipos
      , IDisposable
{
...
#region "Metodos de la Clase"
         ...
         try
         {
           ...
           cn.Open();
               using (SqlCommand cmd = new SqlCommand())
               {
                  ...
                  cmd.Connection = cn;
                  cmd.Parameters.AddWithValue ("@IdProductoTipo", IdProductoTipo);
                  cmd.Parameters.AddWithValue ("@IdProductoGrupo", IdProductoGrupo);
                  cmd.Parameters.AddWithValue ("@ProductoTipo", ProductoTipo);
     ...
     // Funcion que LlenarDatos datos
        ...
        /// </summary>
        /// <remarks></remarks>
      protected entProductosTipos LlenarDatos()
      {
         entProductosTipos LlenarDatos = new entProductosTipos();
         DataTable dt = new DataTable("entProductosTipos");
         ...
         try
         {
           ...
           cn.Open();
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                LlenarDatos = javaScriptSerializer.Deserialize<entProductosTipos>(jsonObject);
            }
            else
            {
              LlenarDatos = null;
      ...
      {
         DataTable dt = new DataTable("ProductosTipos");
