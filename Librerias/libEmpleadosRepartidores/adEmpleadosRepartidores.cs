...
namespace AnceSystem.libEmpleadosRepartidores
{
   ...
   public class adEmpleadosRepartidores : entEmpleadosRepartidores
      , IDisposable
{
...
#region "Metodos de la Clase"
     ...
     // Funcion que LlenarDatos datos
        ...
        /// </summary>
        /// <remarks></remarks>
      protected entEmpleadosRepartidores LlenarDatos()
      {
         entEmpleadosRepartidores LlenarDatos = new entEmpleadosRepartidores();
         DataTable dt = new DataTable("entEmpleadosRepartidores");
         ...
         try
         {
           ...
           cn.Open();
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                LlenarDatos = javaScriptSerializer.Deserialize<entEmpleadosRepartidores>(jsonObject);
            }
            else
            {
              LlenarDatos = null;
      ...
      {
         DataTable dt = new DataTable("EmpleadosRepartidores");
