...
{
    public class adProductosSubTipos : entProductosSubTipos
        , IDisposable
    {
        ...
        protected void Insertar()
        {
            try
            {
                ...
                using (SqlCommand cmd = new SqlCommand())
                {
                    ...
                    cmd.Parameters.AddWithValue("@IdProductoSubTipo", IdProductoSubTipo);
                    cmd.Parameters.AddWithValue("@IdProductoTipo", IdProductoTipo);
                    cmd.Parameters.AddWithValue("@ProductoSubTipo", ProductoSubTipo);
        ...
        protected entProductosSubTipos LlenarDatos()
        {
            entProductosSubTipos LlenarDatos = new entProductosSubTipos();
            DataTable dt = new DataTable("entProductosSubTipos");
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    LlenarDatos = javaScriptSerializer.Deserialize<entProductosSubTipos>(jsonObject);
                }
                else
                {
                    LlenarDatos = null;
