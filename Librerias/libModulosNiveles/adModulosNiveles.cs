...
namespace AnceSystem.libModulosNiveles
{
   ...
   public class adModulosNiveles : entModulosNiveles
      , IDisposable
{
...
#region "Metodos de la Clase"
         ...
         try
         {
           ...
           cn.Open();
               using (SqlCommand cmd = new SqlCommand())
               {
                  ...
                  cmd.Connection = cn;
                  cmd.Parameters.AddWithValue ("@IdModuloNivel", IdModuloNivel);
                  cmd.Parameters.AddWithValue ("@IdModulo", IdModulo);
                  cmd.Parameters.AddWithValue ("@IdNivelUsuario", IdNivelUsuario);
     ...
     // Funcion que LlenarDatos datos
        ...
        /// </summary>
        /// <remarks></remarks>
      protected entModulosNiveles LlenarDatos()
      {
         entModulosNiveles LlenarDatos = new entModulosNiveles();
         DataTable dt = new DataTable("entModulosNiveles");
         ...
         try
         {
           ...
           cn.Open();
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                LlenarDatos = javaScriptSerializer.Deserialize<entModulosNiveles>(jsonObject);
            }
            else
            {
              LlenarDatos = null;
      ...
      {
         DataTable dt = new DataTable("ModulosNiveles");
