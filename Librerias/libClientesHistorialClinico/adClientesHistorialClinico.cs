...
namespace AnceSystem.libClientesHistorialClinico
{
   ...
   public class adClientesHistorialClinico : entClientesHistorialClinico
      , IDisposable
{
...
#region "Metodos de la Clase"
        ...
        /// </summary>
        /// <remarks></remarks>
      public adClientesHistorialClinico(string sNombreCn = "")
        {
            ...
            uspStoreProcedure = "uspClientesHistorialClinico";
      }
         ...
         try
         {
           ...
           cn.Open();
               using (SqlCommand cmd = new SqlCommand())
               {
                  ...
                  cmd.Parameters.AddWithValue ("@IdSucursalVisita", IdSucursalVisita);
                  ...
                  cmd.Parameters.AddWithValue ("@MedicamentoConsumido", MedicamentoConsumido);
                  cmd.Parameters.AddWithValue ("@Observaciones", Observaciones);
                    cmd.Parameters.AddWithValue("@HistorialOptico", HistorialOptico);
                    cmd.Parameters.AddWithValue ("@Fuma", Fuma);
                  cmd.Parameters.AddWithValue ("@Toma", Toma);
     ...
     // Funcion que LlenarDatos datos
        ...
        /// </summary>
        /// <remarks></remarks>
      protected entClientesHistorialClinico LlenarDatos()
      {
         entClientesHistorialClinico LlenarDatos = new entClientesHistorialClinico();
         DataTable dt = new DataTable("entClientesHistorialClinico");
         ...
         try
         {
           ...
           cn.Open();
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                LlenarDatos = javaScriptSerializer.Deserialize<entClientesHistorialClinico>(jsonObject);
            }
            else
            {
              LlenarDatos = null;
      ...
      {
         DataTable dt = new DataTable("ClientesHistorialClinico");
