...
{
    public class adModulosTipos : entModulosTipos
        , IDisposable
    {
        ...
        protected void Insertar()
        {
            try
            {
                ...
                using (SqlCommand cmd = new SqlCommand())
                {
                    ...
                    cmd.Parameters.AddWithValue("@IdModuloTipo", IdModuloTipo);
                    cmd.Parameters.AddWithValue("@ModuloTipo", ModuloTipo);
        ...
        protected entModulosTipos LlenarDatos()
        {
            entModulosTipos LlenarDatos = new entModulosTipos();
            DataTable dt = new DataTable("entModulosTipos");
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    LlenarDatos = javaScriptSerializer.Deserialize<entModulosTipos>(jsonObject);
                }
                else
                {
                    LlenarDatos = null;
