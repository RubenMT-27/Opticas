...
{
    public class adProductos : entProductos
        , IDisposable
    {
        ...
        protected entProductos LlenarDatos()
        {
            entProductos LlenarDatos = new entProductos();
            DataTable dt = new DataTable("entProductos");
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    LlenarDatos = javaScriptSerializer.Deserialize<entProductos>(jsonObject);
                }
                else
                {
                    LlenarDatos = null;
