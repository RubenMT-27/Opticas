...
namespace AnceSystem.libEmpleados
{
   ...
   public class adEmpleados : entEmpleados
      , IDisposable
{
...
#region "Metodos de la Clase"
        ...
        /// </summary>
        /// <remarks></remarks>
      public adEmpleados(string sNombreCn ="")
      {
            ...
            uspStoreProcedure = "uspEmpleados";
        }
     ...
     // Funcion que LlenarDatos datos
        ...
        /// </summary>
        /// <remarks></remarks>
      protected entEmpleados LlenarDatos()
      {
         entEmpleados LlenarDatos = new entEmpleados();
         DataTable dt = new DataTable("entEmpleados");
         ...
         try
         {
           ...
           cn.Open();
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                LlenarDatos = javaScriptSerializer.Deserialize<entEmpleados>(jsonObject);
            }
            else
            {
              LlenarDatos = null;
