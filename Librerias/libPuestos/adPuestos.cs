...
namespace AnceSystem.libPuestos
{
   ...
   public class adPuestos : entPuestos
      , IDisposable
{
...
#region "Metodos de la Clase"
        ...
        /// </summary>
        /// <remarks></remarks>
      public adPuestos(string sNombreCn = "")
        {
     ...
     // Funcion que LlenarDatos datos
        ...
        /// </summary>
        /// <remarks></remarks>
      protected entPuestos LlenarDatos()
      {
         entPuestos LlenarDatos = new entPuestos();
         DataTable dt = new DataTable("entPuestos");
         ...
         try
         {
           ...
           cn.Open();
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                LlenarDatos = javaScriptSerializer.Deserialize<entPuestos>(jsonObject);
            }
            else
            {
              LlenarDatos = null;
