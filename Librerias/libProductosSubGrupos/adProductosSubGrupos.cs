...
{
    public class adProductosSubGrupos : entProductosSubGrupos
        , IDisposable
    {
        ...
        protected void Insertar()
        {
            try
            {
                ...
                using (SqlCommand cmd = new SqlCommand())
                {
                    ...
                    cmd.Parameters.AddWithValue("@IdProductoSubGrupo", IdProductoSubGrupo);
                    cmd.Parameters.AddWithValue("@IdProductoGrupo", IdProductoGrupo);
                    cmd.Parameters.AddWithValue("@ProductoSubGrupo", ProductoSubGrupo);
        ...
        protected entProductosSubGrupos LlenarDatos()
        {
            entProductosSubGrupos LlenarDatos = new entProductosSubGrupos();
            DataTable dt = new DataTable("entProductosSubGrupos");
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    LlenarDatos = javaScriptSerializer.Deserialize<entProductosSubGrupos>(jsonObject);
                }
                else
                {
                    LlenarDatos = null;
