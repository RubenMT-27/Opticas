...
{
    public class adModulos : entModulos
        , IDisposable
    {
        ...
        protected entModulos LlenarDatos()
        {
            entModulos LlenarDatos = new entModulos();
            DataTable dt = new DataTable("entModulos");
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    LlenarDatos = javaScriptSerializer.Deserialize<entModulos>(jsonObject);
                }
                else
                {
                    LlenarDatos = null;
