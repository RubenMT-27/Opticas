...
namespace AnceSystem.libNivelesUsuarios
{
   ...
   public class adNivelesUsuarios : entNivelesUsuarios
      , IDisposable
{
...
#region "Metodos de la Clase"
     ...
     // Funcion que LlenarDatos datos
        ...
        /// </summary>
        /// <remarks></remarks>
      protected entNivelesUsuarios LlenarDatos()
      {
         entNivelesUsuarios LlenarDatos = new entNivelesUsuarios();
         DataTable dt = new DataTable("entNivelesUsuarios");
         ...
         try
         {
           ...
           cn.Open();
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                LlenarDatos = javaScriptSerializer.Deserialize<entNivelesUsuarios>(jsonObject);
            }
            else
            {
              LlenarDatos = null;
      ...
      {
         DataTable dt = new DataTable("NivelesUsuarios");
