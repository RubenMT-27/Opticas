...
namespace AnceSystem.libProductosCostos
{
   ...
   public class adProductosCostos : entProductosCostos
      , IDisposable
{
...
#region "Metodos de la Clase"
         ...
         try
         {
           ...
           cn.Open();
               using (SqlCommand cmd = new SqlCommand())
               {
                  ...
                  cmd.Connection = cn;
                  cmd.Parameters.AddWithValue ("@IdProductoCosto", IdProductoCosto);
     ...
     // Funcion que LlenarDatos datos
        ...
        /// </summary>
        /// <remarks></remarks>
      protected entProductosCostos LlenarDatos()
      {
         entProductosCostos LlenarDatos = new entProductosCostos();
         DataTable dt = new DataTable("entProductosCostos");
         ...
         try
         {
           ...
           cn.Open();
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                LlenarDatos = javaScriptSerializer.Deserialize<entProductosCostos>(jsonObject);
            }
            else
            {
              LlenarDatos = null;
      ...
      {
         DataTable dt = new DataTable("ProductosCostos");
