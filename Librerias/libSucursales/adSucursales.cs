...
namespace AnceSystem.libSucursales
{
   ...
   public class adSucursales : entSucursales
      , IDisposable
{
...
#region "Metodos de la Clase"
        ...
        /// </summary>
        /// <remarks></remarks>
      public adSucursales(string sNombreCn = "")
      {
            ...
            uspStoreProcedure = "uspSucursales";
        }
     ...
     // Funcion que LlenarDatos datos
        ...
        /// </summary>
        /// <remarks></remarks>
      protected entSucursales LlenarDatos()
      {
         entSucursales LlenarDatos = new entSucursales();
         DataTable dt = new DataTable("entSucursales");
         ...
         try
         {
           ...
           cn.Open();
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                LlenarDatos = javaScriptSerializer.Deserialize<entSucursales>(jsonObject);
            }
            else
            {
              LlenarDatos = null;
