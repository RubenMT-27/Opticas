...
{
    public class adProductosGrupos : entProductosGrupos
        , IDisposable
    {
        ...
        protected void Insertar()
        {
            try
            {
                ...
                using (SqlCommand cmd = new SqlCommand())
                {
                    ...
                    cmd.Parameters.AddWithValue("@ProductoGrupo", ProductoGrupo);
        ...
        protected entProductosGrupos LlenarDatos()
        {
            entProductosGrupos LlenarDatos = new entProductosGrupos();
            DataTable dt = new DataTable("entProductosGrupos");
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    LlenarDatos = javaScriptSerializer.Deserialize<entProductosGrupos>(jsonObject);
                }
                else
                {
                    LlenarDatos = null;
