<%@ Page Title="" Language="C#" MasterPageFile="~/mpOpticas.Master" AutoEventWireup="true" CodeBehind="Puestos.aspx.cs" Inherits="OpticasWeb.Puestos" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphPrincipal" runat="server">
    <h1 class="page-header p-1 text-white">Catálogo Puestos<small class="text-white"> Gran Visión</small></h1>
...
<asp:Content ID="Content4" ContentPlaceHolderID="cphScripts" runat="server">
    ...
    <script src="js/jsPuestos.js"></script>

    <script id="ControlesWindowTemplate" type="text/x-kendo-template">        
        <input id="hidIdPuesto" type="hidden" />
        <input id="txtPuesto">
