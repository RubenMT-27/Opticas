<%@ Page Title="" Language="C#" MasterPageFile="~/mpOpticas.Master" AutoEventWireup="true" CodeBehind="ProductosGrupos.aspx.cs" Inherits="OpticasWeb.ProductosGrupos" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphPrincipal" runat="server">
    <h1 class="page-header p-1 text-white">Catálogo Grupos de Productos<small class="text-white"> Gran Visión</small></h1>
...
<asp:Content ID="Content4" ContentPlaceHolderID="cphScripts" runat="server">
    ...
    <script src="js/jsProductosGrupos.js"></script>

    <script id="ControlesWindowTemplate" type="text/x-kendo-template">        
        <input id="hidIdProductoGrupo" type="hidden" />
        <input id="txtProductoGrupo" />
