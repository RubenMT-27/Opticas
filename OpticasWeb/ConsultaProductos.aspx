<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/mpOpticas.Master" CodeBehind="ConsultaProductos.aspx.cs" Inherits="OpticasWeb.ConsultaProductos" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphPrincipal" runat="server">
    <h1 class="page-header p-1 text-white">Consulta de Productos<small class="text-white"> Gran Visión</small></h1>
