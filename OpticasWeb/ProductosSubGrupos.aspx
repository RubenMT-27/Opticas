<%@ Page Title="" Language="C#" MasterPageFile="~/mpOpticas.Master" AutoEventWireup="true" CodeBehind="ProductosSubGrupos.aspx.cs" Inherits="OpticasWeb.ProductosSubGrupos" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphPrincipal" runat="server">
    <h1 class="page-header p-1 text-white">Catálogo SubGrupos de Productos<small class="text-white"> Gran Visión</small></h1>
        ...
        <div class="col-lg-8 col-md-12">
            <div class="card">
                ...
                <div class="card-body p-t-10" style="height: 70vh;">
                    <div id="kdGridSubGruposProductos">
                        <div id="kdWindow">
                        </div>
                    </div>
                </div>
...
<asp:Content ID="Content4" ContentPlaceHolderID="cphScripts" runat="server">
    ...
    <script src="js/jsProductosSubGrupos.js"></script>

    <script id="ControlesWindowTemplate" type="text/x-kendo-template">        
        <input id="hidIdSubGrupo" type="hidden" />
        <input id="ddlGrupo" />
        <input id="txtSubGrupo" />
