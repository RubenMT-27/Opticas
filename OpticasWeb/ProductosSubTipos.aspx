<%@ Page Title="" Language="C#" MasterPageFile="~/mpOpticas.Master" AutoEventWireup="true" CodeBehind="ProductosSubTipos.aspx.cs" Inherits="OpticasWeb.ProductosSubTipos" %>
        ...
        <div class="col-lg-8 col-md-12">
            <div class="card">
                ...
                <div class="card-body p-t-10" style="height: 70vh;">
                    <div id="kdGridTiposSubProductos">
                        <div id="kdWindow">
                        </div>
                    </div>
                </div>
...
<asp:Content ID="Content4" ContentPlaceHolderID="cphScripts" runat="server">
    ...
    <script src="js/jsProductosSubTipos.js"></script>

    <script id="ControlesWindowTemplate" type="text/x-kendo-template">        
        <input id="hidIdProductoSubTipo" type="hidden" />
        <input id="ddlProductoTipo" />
        <input id="txtProductoSubTipo" />
